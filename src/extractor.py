...
def extract_data():
    ...
    if json.load(open("../settings/settings.json"))["settings"]["result_display_method"] == "file":
    ...
    elif json.load(open("../settings/settings.json"))["settings"]["result_display_method"] == "console":
